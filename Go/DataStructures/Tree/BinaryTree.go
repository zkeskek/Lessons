...
// Search Arama yap ve sonucu yazdır
func (tree *binaryTree) Search(data int) {
	if recursiveSearch(data, tree){
		fmt.Printf("%v: ağaç içersinde mevcuttur\n", data)
	}else{
		fmt.Printf("%v: değeri bulunamadı\n", data)
	}
}

// Exists Arama yap sonucu true vea false olarak dön
...
// Ekleme işlemi için recursive func
...
// Arama işlemi için recurive func
...
// Silme işlemi için recurive func
